...
const protectedPrefixes = ["/dashboard", "/agents", "/risk", "/policy", "/compliance", "/integrations"];
const protectedApiPrefixes = ["/api/agents", "/api/findings", "/api/integrations", "/api/evidence", "/api/policies"];
